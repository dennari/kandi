...
Valittujen työssä esiteltyjen menetelmien suorituskykyä arvioidaan kahden koetilanteen avulla.
Ensimmäisessä koetilanteessa keskitytään approksimoimaan kahden muuttujan
...
Ensimmäisen koetilanteen kubatuureiksi valitaan seuraavat menetelmät:
\begin{itemize}
...
$Q_{68}$:n tarkkuusaste on $19$ ja se on johdettu aiemmin esiteltyä invarianttimenetelmää käyttäen \cite{Omelyan2006}. 
Sen tukipisteiden määrä on myös pienin tunnettu sarjassaan.

Taulukossa \ref{table_results1} on esitetty ensimmäisen koetilanteen tulokset.
Siihen lisäksi laskettu absoluuttinen virhe, joka on saatu vertaamalla
...
\begin{table}[h!]
	\centering
	\topcaption{Ensimmäisen koetilanteen tulokset}
