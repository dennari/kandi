...
\begin{equation}
	\defint{\Omega}{}{f(\v{x})w(\v{x})}{\Omega} = \sum_{i=1}^Nw_if(\v{x}_i)+E,
	\label{eq_cubature} 
\end{equation}
...
Sanotaan että kvadratuurisäännön (algebrallinen) \emph{tarkkuusaste} on $d$, jos se antaa tarkan tuloksen kaikille polynomeille, jotka ovat 
